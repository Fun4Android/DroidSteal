...
public class DBHelper {
    ...
    private static final String DROIDSTEAL_DBNAME = "droidsteal";
    private static final String CREATE_PREFERENCES = "CREATE TABLE IF NOT EXISTS DROIDSTEAL_PREFERENCES "
            + "(id integer primary key autoincrement, " + "name  varchar(100)," + "value varchar(100));";
    private static final String CREATE_BLACKLIST = "CREATE TABLE IF NOT EXISTS DROIDSTEAL_BLACKLIST "
