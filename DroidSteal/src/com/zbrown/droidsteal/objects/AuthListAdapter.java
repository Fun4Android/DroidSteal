...
public class AuthListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (auth.isSaved()) {
            itemLayout.setBackgroundColor(Color.argb(50, 155, 166, 166));
        ...
        } else if (auth.getUrl().contains("xda-developers")) {
            imgView.setImageDrawable(context.getResources().getDrawable(R.drawable.xda));
        } else {
