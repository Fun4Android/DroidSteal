...
public class ListenActivity extends Activity implements OnClickListener, OnItemClickListener, OnItemLongClickListener,
    ...
    protected void onStart() {
        ...
        //showUpdate(); // Disabled -- currently broken/unreliable and annoying for users
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        // This is entirely unnecessary but I think most will find using the app in landscape laughable at best
    ...
    void refreshStatus() {
        ...
        if (listening && !spoofing) {
            ...
            actionbar.setSubtitle("SPOOFING ONLY"); // this shouldn't occur usually
            setProgressBarIndeterminateVisibility(true);
        } else {
            actionbar.setSubtitle("IDLE");
            setProgressBarIndeterminateVisibility(false);
